package com.wjy.sso.service;

import com.auth0.jwt.interfaces.Claim;
import com.wjy.sso.entity.User;
import com.wjy.sso.exception.CustomException;
import com.wjy.sso.util.JwtUtil;
import com.wjy.sso.util.RedisUtil;
    ...
    public String login(User user) {
        ...
        try {
            if (user.getName().equalsIgnoreCase(user.getPassword())) {
                return generateNewJwt(user.getName());
            } else {
